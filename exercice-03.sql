...
SELECT *
FROM project
WHERE (description != '%Dolores%' OR start_date >= '2021-07-01')
...
SELECT * 
FROM project
WHERE (description != '%Dolores%' AND start_date >= '2021-07-01')
...
SELECT *
FROM project
WHERE (start_date >= '2021-01-01' AND delivery_date <= '2021-07-01')
